...
public class pageResolverN {
	
	private SearchItem sc;

	private int totalCntN; // 게시물 총 개수 
	...
	public pageResolverN(int totalCntN, Integer page) {
		this(totalCntN, new SearchItem(page, 10));
	}
	
	public pageResolverN(int totalCntN, Integer page, Integer pageSize) {
		this(totalCntN, new SearchItem(page, pageSize));
	}
	
	public pageResolverN(int totalCntN, SearchItem sc) {
		this.totalCntN = totalCntN;
		this.sc = sc;
		
		doPaging(totalCntN, sc);
	}
	
	public void doPaging(int totalCntN, SearchItem sc) {
		this.totalPage = totalCntN / sc.getPageSize() + (totalCntN % sc.getPageSize() == 0 ? 0 : 1); // 전체 페이지 개수
	...
	public String toString() {
		return "PageResolver [sc=" + sc + ", totalCntN=" + totalCntN + ", totalPage=" + totalPage + ", beginPage="
	...
	public void settotalCntN(int totalCntN) {
		this.totalCntN = totalCntN;
	}
