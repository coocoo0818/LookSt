...
public class snsPrdtImgDto {

	private String post_tag_img;
	private String post_tag_price;
	private String post_tag_name;
	
	public snsPrdtImgDto() {
		
	}

	public snsPrdtImgDto(String post_tag_img, String post_tag_price, String post_tag_name) {
		//super();
	...
	public String toString() {
		return "snsImgListprdt [post_tag_img=" + post_tag_img + ", post_tag_price=" + post_tag_price
