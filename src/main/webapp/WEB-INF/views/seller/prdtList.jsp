...
<h2 id="orderpagetitle" class="disply-2 text-center py-4">PRODUCT LIST</h2>	
...
<div class="container">
	<div class="row">
		<div>
          ...
          <a role="button" class="btn btn-outline-danger ms-1" href="<c:url value="/seller/registerPrdt"/>" style="float:right">상품 등록</a>
        </div>
    </div>
</div>
