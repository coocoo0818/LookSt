 		 ...
 		 <div class="col">
    		<div class="card">
  				...
  				<div class="row justify-content-between pb-3">
				    ...
				    <div class="col-6"> 
				    <a class="card-text link-danger" href="<c:url value="/seller/orderList"/>"  style="float:right">2건</a>
				    </div>
				  </div>
				  <div class="row justify-content-between pb-3">
				    <div class="col-6">
				    ...
				    <div class="col-6"> 
				    <a class="card-text link-danger" href="<c:url value="/seller/refundList"/>" style="float:right">2건</a>
				    </div>
				  </div>
				</div>
			</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/seller/js/bootstrap.bundle.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/seller/js/dashboard.js"></script>
</body>
</html>