...
<body>
	<%@ include file="/WEB-INF/views/fix/header.jsp"%>
			...
			<button class="seller-btn" type="button">임시버튼</button>
			

	<div class="container w-75 mt-5 mb-5">
	<!-- Content here -->
		<form action="./register" method="post" onsubmit="registerSuccess();" >
			<div class="container w-75 pt-2">
				...
				<div class="form-group">
				  <fieldset>
					...
					<div class="input-group mb-2" style="height:50px;">
						...
						<select class="form-select" name="email_host" id="email_host" onkeyup="checkId()">
				...
				<div class="d-grid gap-2 pt-4 pb-5 mb-5">
					<input class="btn btn-primary" type="submit" style="height:60px;" id="submit" value="가입하기"/>
				</div>
			</div>
		</form>
	</div>
