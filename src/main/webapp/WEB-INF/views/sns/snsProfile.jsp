...
$(document).ready(function() {
	...
	$('#infoSave').on('click', function() {
		...
		$.ajax({
				...
				data : JSON.stringify({member_nickname : nickName}),	
		...
		<div
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<input type="submit" id="infoSave" class="submit btn btn-primary"
						value="저장">
				</div>
			</div>
		</div>
						...
						<c:if
							...
							<c:forEach var="pro_following" items="${pro_following }"
								...
								<li class="fs-4" style="list-style: none;"
									data-memberID="${pro_following.following}"><a
									href="${contextPath}/sns/snsProfile/?member_id=${pro_following.following}"
